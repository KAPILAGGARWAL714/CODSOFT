...
import random
#set user and system score to zero initially
user_score=0
computer_score=0
...
while True: 
    ...
    # OR is the short-circuit operator if any one of the condition is true
    ...
    # Computer chooses randomly any number among 1 , 2 and 3 Using randint methodm of random module
    ...
    # if user input n then condition is True
    ans = input()
    if ans.lower() =='n':
        break
